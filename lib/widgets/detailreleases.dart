      ...
      body: Center(
        child: ListView(
          children: <Widget>[
            Stack(
              children: <Widget>[
                ForegroundContent(releasesObject: releasesObject),
              ],
            )
          ],
        ),
...
class ForegroundContent extends StatelessWidget {
  const ForegroundContent({@required this.releasesObject});
            ...
            Column(
              children: <Widget>[
                Container(
                  ...
                  height: 200,
                  width: 300,
                  child: Image.asset(releasesObject.image),
                ),
                Padding(
